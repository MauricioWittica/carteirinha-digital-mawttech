...
export const FirstStepsContext = createContext<FirstStepsContextData>({} as FirstStepsContextData);
...
export const FirstStepsProvider = ({ children }) => {
    ...
    const [showFirstSteps, setShowFirstSteps] = useState('show');
    const [showIntro, setShowIntro] = useState('show');
    const [activeFirstStepsStage1, setActiveFirstStepsStage1] = useState(true);
    ...
    const [activeFirstStepsStage6, setActiveFirstStepsStage6] = useState(false);
    ...
    useEffect(() => {
        const loadStorage = async () => {
            ...
            try {
                const storageShowFirstSteps = await AsyncStorage.getItem('@MAW_PRTB_FirstSteps:showFirstSteps')
    ...
    function hiddenMessageIntroRegister() {
        ...
        console.log('Primeiros passos iniciados abrindo formulário de cadastro de usuário...')
    ...
    async function hiddenMessageRegisterSelf() {
        ...
        console.log('Todas etapas concluidas.fazendo login de usuário..')


    }
    return (
        <FirstStepsContext.Provider value={{
            activeFirstStepsStage5, activeFirstStepsStage6, activeFirstStepsStage7, activeFirstStepsStage4, showIntro, showFirstSteps, activeFirstStepsStage1, activeFirstStepsStage2, activeFirstStepsStage3, hiddenMessageIntroRegister, hiddenRegisterAccount, hiddenRegisterCard, hiddenMessageRegisterAccount, hiddenMessageRegisterCard, hiddenRegisterSelf, hiddenMessageRegisterSelf,  setShowFirstSteps, setShowIntro, account, setAccount, setRegisterCard, setRegisterSelf, registerCard, registerSelf
        }}>
            {children}
