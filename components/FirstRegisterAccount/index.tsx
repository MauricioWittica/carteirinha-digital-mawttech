...
const FirstRegisterAccount = () => {
    const { hiddenMessageIntroRegister, hiddenMessageRegisterAccount} = useContext(FirstStepsContext);
        ...
        <ScrollView>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.textHeaderContainer}>
                    ...
                    <Text style={styles.textSubTitle}>Sua conta foi criada com sucesso.</Text>
