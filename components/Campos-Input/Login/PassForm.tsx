...
ContainerPass.Input1 = styled.TextInput`
...
ContainerPass.Input2 = styled.TextInput`
flex:1;
text-align: center;
border-radius: 15px;
border-color: grey;
...
ContainerPass.Input3 = styled.TextInput`
flex:1;
text-align: center;
border-radius: 15px;
border-color: grey;
...
ContainerPass.Input4 = styled.TextInput`
flex:1;
text-align: center;
border-radius: 15px;
border-color: grey;
...
`;
ContainerPass.Input5 = styled.TextInput`
flex:1;
text-align: center;
border-radius: 15px;
border-color: grey;
...
ContainerPass.Input6 = styled.TextInput`
flex:1;
text-align: center;
border-radius: 15px;
border-color: grey;
  ...
  return (
    ...
    <View>
      <ContainerTela.PassInput>
        <ContainerPass>
          <ContainerPass.Input1 style={{ backgroundColor: input1 ? focuBackground.focused : focuBackground.unfocused }}
            ref={n1Ref}
            returnKeyType={"next"}
          ...
          <ContainerPass.Input2 style={{ backgroundColor: input2 ? focuBackground.focused : focuBackground.unfocused }}
            ref={n2Ref}
            returnKeyType={"next"}
            onChangeText={(text) => { setInput2(false), text != '' ? n3Ref.current.focus() : "", n2Ref.current.value = text }}
          ...
          <ContainerPass.Input3 style={{ backgroundColor: input3 ? focuBackground.focused : focuBackground.unfocused }}
            ref={n3Ref}
            returnKeyType={"next"}
            onChangeText={(text) => { setInput3(false), text != '' ? n4Ref.current.focus() : "", n3Ref.current.value = text }}
          ...
          <ContainerPass.Input4 style={{ backgroundColor: input4 ? focuBackground.focused : focuBackground.unfocused }}
            ref={n4Ref}
            returnKeyType={"next"}
            onChangeText={(text) => { setInput4(false), text != '' ? n5Ref.current.focus() : "", n4Ref.current.value = text }}
          ...
          <ContainerPass.Input5 style={{ backgroundColor: input5 ? focuBackground.focused : focuBackground.unfocused }}
            ref={n5Ref}
            returnKeyType={"next"}
            onChangeText={(text) => { setInput5(false), text != '' ? n6Ref.current.focus() : "", n5Ref.current.value = text }}
          ...
          <ContainerPass.Input6 style={{ backgroundColor: input6 ? focuBackground.focused : focuBackground.unfocused }}
            ref={n6Ref}
            returnKeyType={"send"}
            onChangeText={(text) => { setInput6(false), n6Ref.current.value = text }}
        ...
        <TextInput
          ...
          onSubmitEditing={() => { n1Ref.current.focus(); }}
          blurOnSubmit={false}
